...
do
	...
	curl -iX PUT --url "http://192.168.111.129:1026/v2/entities/${name}/attrs/temperature/value"   --header 'Content-Type: text/plain'   --data $temperature
	curl -iX PUT --url "http://192.168.111.129:1026/v2/entities/${name}/attrs/humidity/value"   --header 'Content-Type: text/plain'   --data $humidity
	...
	curl -iX PUT --url "http://192.168.111.129:1026/v2/entities/${name}/attrs/temperature/value"   --header 'Content-Type: text/plain'   --data $temperature
	curl -iX PUT --url "http://192.168.111.129:1026/v2/entities/${name}/attrs/humidity/value"   --header 'Content-Type: text/plain'   --data $humidity
	curl -iX PUT --url "http://192.168.111.129:1026/v2/entities/${name}/attrs/pressure/value"   --header 'Content-Type: text/plain'   --data $pressure
